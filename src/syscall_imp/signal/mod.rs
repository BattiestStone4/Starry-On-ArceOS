...
use crate::ctypes::{SigMaskFlag, SIGSET_SIZE_IN_BYTE};
...
pub fn sys_rtsigprocmask(flag: usize, new_mask: *const usize, old_mask: *mut usize, sigsetsize: usize) -> usize {
    syscall_body!(sys_rtsigprocmask, {
        let sigmaskflag = SigMaskFlag::from(flag);
